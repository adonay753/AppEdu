...
public class SubirTareaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_subir_tarea);
    ...
    private void publicar() {
        ...
        Toast.makeText(SubirTareaActivity.this,"FileUploaded",Toast.LENGTH_SHORT).show();
        titulo.setText("");
        descripcion.setText("");
    }
