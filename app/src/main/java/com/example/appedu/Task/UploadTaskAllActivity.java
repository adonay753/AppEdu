...
public class UploadTaskAllActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upload_task_all);

        userList = getIntent().getStringArrayListExtra("usuario");

        editPdfname=(EditText)findViewById(R.id.txtTituloProfe_all);
        editDescripcion=findViewById(R.id.txtTarea_all);
        btn_upload=(Button)findViewById(R.id.btn_subirArchivoEstudiante_all);

        mAuth = FirebaseAuth.getInstance();
        storageReference= FirebaseStorage.getInstance().getReference();
        dato_recibido = getIntent().getStringExtra("token");
        ...
        reference.putFile(data)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        Toast.makeText(UploadTaskAllActivity.this,"FileUploaded",Toast.LENGTH_SHORT).show();
