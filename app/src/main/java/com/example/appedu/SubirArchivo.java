...
public class SubirArchivo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference= FirebaseDatabase.getInstance().getReference(editPdfname.getText().toString());///referencia de la base de datos cambiarlo por otro
        ...
        reference.putFile(data)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        Toast.makeText(SubirArchivo.this,"FileUploaded",Toast.LENGTH_SHORT).show();
